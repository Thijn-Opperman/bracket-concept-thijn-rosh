    ...
    >
      <div className="mx-auto max-w-7xl space-y-8">
        ...
        >
          ...
          <Link
            href="/admin"
            className="absolute top-6 right-6 z-10 rounded-full border border-white/20 bg-white/5 px-4 py-2 text-xs font-semibold uppercase tracking-widest text-white/70 transition hover:border-white/50 hover:bg-white/10 hover:text-white"
            title="Ga naar Admin Console"
          >
